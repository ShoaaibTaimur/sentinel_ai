...
export default function Sidebar({ currentPage, onNavigate, onClose }: Props) {
  ...
  return (
    <div className="sidebar">
      ...
      <button className="sidebar-item" onClick={() => window.sentinel.closeWindow()} title="Hide window to background">
        <span className="icon" style={{ display: 'inline-flex', alignItems: 'center' }}>
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <button className="sidebar-item sidebar-exit" onClick={() => window.sentinel.quitApp()} title="Terminate Sentinel AI process">
        <span className="icon" style={{ display: 'inline-flex', alignItems: 'center' }}>
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
